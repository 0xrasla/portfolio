...
>
  ...
  >
    <div class="flex items-center gap-3">
      ...
      <span>Initialize // <span class="hidden md:inline">0xRASLA</span></span>
    </div>
  ...
  >
    <div
      class="relative w-full overflow-hidden text-center h-37.5 md:h-62.5 flex items-center justify-center"
    >
